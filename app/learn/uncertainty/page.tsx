...
export default function UncertaintyPage() {
  return (
    <section className="prose dark:prose-invert max-w-none">
      ...
      <p>
        PMP wants to see risk thinking everywhere:{' '}
        <strong>identify → analyze → plan responses → monitor</strong>, across threats <em>and</em>{' '}
        opportunities.
      </p>
      ...
      <ul>
        ...
        <li>
          Responses: Threat vs. Opportunity (avoid/mitigate/transfer vs. exploit/enhance/share)
        </li>

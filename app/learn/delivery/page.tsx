  ...
  return (
    <section className="prose dark:prose-invert max-w-none">
      ...
      <p>
        ...
        <strong>deliver usable value</strong>
        in agreed increments, meet acceptance criteria, and handle changes through a disciplined
        process.
      </p>
      ...
      <ul>
        <li>
          Shipping a feature that doesn’t match acceptance criteria is <em>not</em> “done”. Re-plan
          or raise a change — don’t bypass control.
        </li>
        <li>“Stakeholder asked for this” ≠ approved change. Use the formal CR flow.</li>
        <li>
          In hybrid, keep the predictive baselines but deliver increments with agile ceremonies — be
          explicit about which rules apply.
        </li>
      </ul>

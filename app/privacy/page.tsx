...
export default function PrivacyPage() {
  return (
    <section className="prose max-w-none dark:prose-invert">
      ...
      <p>
        At <strong>Pass PMP Now</strong> (<a href="https://passpmpnow.com">https://passpmpnow.com</a>),
      ...
      <p>
        ...
        We never sell email lists to third parties. You can unsubscribe anytime from any email you receive.
      </p>
